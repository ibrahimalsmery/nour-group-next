function Page() {
    return (
        <main className="max-w-4xl mx-auto px-4 py-8">
            <h1 className="text-4xl font-bold mb-6 text-center text-blue-800">التوظيف</h1>
            ...
            <section className="mb-8">
                <h2 className="text-2xl font-semibold mb-4 text-blue-800">خدمات التوظيف التي نقدمها</h2>
